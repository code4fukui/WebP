...
import webp_enc from "./enc/webp_enc.js";

const decoder = await webp_dec();
const encoder = await webp_enc();
...
export class WebP {
  ...
  static decode(webpbin) {
    const imageData = decoder.decode(webpbin);
    return imageData;
  }
};
